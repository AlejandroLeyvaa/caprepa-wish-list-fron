...
export class UserComponent implements OnInit {
  ...
  async getDepartments() {
    const request = await fetch('https://0c98-201-164-62-254.ngrok.io/api/auth/departments');
  ...
  async getCurrentUserData() {
    ...
    if (userId && token?.length) {
      const URL = `https://0c98-201-164-62-254.ngrok.io/api/auth/users/${userId}`;
  ...
  async sendUserImage(formData: any) {
    // const response = await fetch('https://0c98-201-164-62-254.ngrok.io/api/auth/users/user-update-image', {
    const response = await fetch('https://0c98-201-164-62-254.ngrok.io/api/auth/users/user-update-image', {
      method: 'PUT',
      body: formData,
    });
  ...
  async sendData(dataForm: any) {
    // const response = await fetch('https://0c98-201-164-62-254.ngrok.io/api/auth/users/user-update', {
    const response = await fetch('https://0c98-201-164-62-254.ngrok.io/api/auth/users/user-update', {
      method: 'PUT',
      headers: {
